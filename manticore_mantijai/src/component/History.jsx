      ...
      <section className="origin">
        <div className="origin-group">
          ...
          <p className="origin-text">
            ...
            Persia. It debuts, with its appearance in around 700 BCE and usually
            ends at around the 9th Century. Some sources state that it
            originated in ancient Persian mythology, while others claim that it
            was an Indian creature. According to Aelian in his Characteristics
            of Animals, "Ctesias claims to have seen one such creature which was
            brought to the Persian king as a gift" (4.21). Other writers back up
            this claim, stating that although Ctesias first saw the creature in
            Persia, it had originally come from India. It is, therefore, perhaps
            correct to say that it originated in Persian literature but was
            portrayed as a creature from Indian mythology.
          </p>
        </div>
      </section>
      ...
      <section className="whatManti">
        ...
        <div className="box-whatManti">
          <p className="whatManti-text">
            ...
            devouring every animal in the jungle except for elephants. There is
            no given explanation for why these creatures were unable to defeat
            elephants, only documentation that for some reason elephants seemed
            to be able to evade even the most powerful of the manticores.
          </p>
