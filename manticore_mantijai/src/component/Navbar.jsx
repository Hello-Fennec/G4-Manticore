        ...
        <nav class="shadow-md w-full fixed top-0 left-0 bg-gradient-to-r from-yellow-600 to-lime-700">
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a href="#" class="flex items-center">                    
                    <span class="font-semibold whitespace-nowrap dark:text-white text-center text-white font-itim" id="logo">MANTICORE <br /> Mantijai</span>
                </a>
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul class="flex flex-col p-12 mt-12 pr-0   md:flex-row md:space-x-16 md:mt-0 md:text-sm md:font-medium md:border-0 text-xl font-inter text-white" id="navbutton">
                        <li>
